                    ...
                    children: [
                      Text("Smart Detection System",
                          style: TextStyle(
                              ...
                              fontWeight: FontWeight.bold)),
                      SizedBox(height: 10),
                      Text("Bluetooth Device: Smartwatch connected ✅",
                          style: TextStyle(color: Colors.green)),
                      Text("Charge: 76% 🔋   Time remaining: 3hr 40 mins",
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Voice and Panic Movement Detection System",
                          style: TextStyle(
                              fontSize: 18,
                              color: Colors.white,
                              fontWeight: FontWeight.bold)),
                      ...
                      Row(
                        ...
                        children: [
                          _toggleSetting("Microphone Access", isMicrophoneOn,
                              (val) {
                            setState(() {
                              isMicrophoneOn = val;
                            });
                          }),
                          _toggleSetting("Panic Movement", isPanicMovementOn,
                              (val) {
                            setState(() {
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {},
                        child: Text("Send recorded voice note",
                            style: TextStyle(color: Colors.white)),
                      ),
                    ],
                  ),
